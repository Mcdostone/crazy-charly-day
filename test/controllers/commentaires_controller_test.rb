...
class CommentairesControllerTest < ActionController::TestCase
  ...
  test "should create commentaire" do
    assert_difference('Commentaire.count') do
      post :create, commentaire: { contenu: @commentaire.contenu, email: @commentaire.email, item_id: @commentaire.item_id }
    end
  ...
  test "should update commentaire" do
    patch :update, id: @commentaire, commentaire: { contenu: @commentaire.contenu, email: @commentaire.email, item_id: @commentaire.item_id }
    assert_redirected_to commentaire_path(assigns(:commentaire))
  end
